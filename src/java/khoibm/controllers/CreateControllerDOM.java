...
@WebServlet(name = "CreateControllerDOM", urlPatterns = {"/CreateControllerDOM"})
public class CreateControllerDOM extends HttpServlet {
            ...
            if (doc != null) {
                ...
                if (list != null) {
                    if (list.getLength() > 0) {
                        ...
                        boolean insertStatus = XMLUtils.transformDomToStreamResult(doc, filePath);
