...
@WebServlet(name = "SearchControllerDOM", urlPatterns = {"/SearchControllerDOM"})
public class SearchControllerDOM extends HttpServlet {
        ...
        try {
            ...
            if (doc != null) {
                ...
                if (studentList != null) {
                    ...
                    request.setAttribute("STUDENT_LIST", theStudentList);
                }
